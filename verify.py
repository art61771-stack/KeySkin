...
for text in ['Package: com.zuotian.keyskin','Version: 0.1.5','Architecture: iphoneos-arm64e']: assert text in control
print(control)
...
assert info['CFBundleVersion']=='0.1.5'
...
assert b'KSSettingsTableController' in prefs and b'PSViewController' in prefs
assert b'/System/Library/PrivateFrameworks/Preferences.framework/Preferences' in prefs
